# PSFC valid-time plot: white legend/title padding, caption and lower ME panel.
# Loaded from the METviewer R_work directory before closing the graphics device.
# Legend placement matches the PSFC fbar_obar_me_by_valid.xml profile.
local({
    ...
    box();
    mtext("ME [hPa]",side=2,line=1,padj=-2,adj=.5,cex=1,font=1,las=0);
})
